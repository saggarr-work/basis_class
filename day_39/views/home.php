        ...
        <div class="container">
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-4">
                        <div class="card mb-3">
                            <img src="<?php echo $product["image"]; ?>" class="card-img-top w-100" height="300px" alt="...">
                            <div class="card-body">
                                <h5 class="card-title text-truncate"><?php echo $product["title"]; ?></h5>
                                <h6 class="card-title">Price: <strike><?php echo $product["price"]["regular"]; ?>tk</strike></h6>
                                <h6 class="card-title">Offer: <?php echo $product["price"]["offer"]; ?>tk</h6>
                                <p class="card-text"><?php echo $product["short_des"]; ?></p>
