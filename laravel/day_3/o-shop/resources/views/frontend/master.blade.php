            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="@yield('shop')"><a href="/shop">Shop page</a></li>
                        <li class="@yield('singleproduct')"><a href="/single-product">Single product</a></li>
                        <li class="@yield('cart')"><a href="/cart">Cart</a></li>
